...
ENV NODE_ENV=production \
    ...
    LS_CLOSED_DECISION_TARGETS=16 \
    LS_CLOSED_NEWS_EXTRA_TARGETS=8 \
    LS_CLOSED_NEWS_BOOST_MAX=15 \
    LS_CLOSED_NEWS_PROMOTION_TARGETS=4 \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_204R1_MONDAY_BUILD_FIX.bin /tmp/app.tar.gz
RUN set -eux; \
