...
ENV NODE_ENV=production \
    APP_VERSION=1.9.25-H3F24-ROOT-CAUSE-FIX-UI-LEDGER5-NXT-FEED-RESTORE-GATEFIX \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1931_H3F24_UI_LEDGER5_NXT_FEED_RESTORE_GATEFIX.bin /tmp/app.tar.gz
RUN set -eux; \
