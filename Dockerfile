...
ENV NODE_ENV=production \
    APP_VERSION=1.9.28-H3F27-NXT-PRE-RATE-TRUTH \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1928_H3F27_NXT_PRE_RATE_TRUTH.bin /tmp/app.tar.gz
RUN set -eux; \
    ...
    node scripts/verify-h3f27-pre-rate.js; \
