...
ENV NODE_ENV=production \
    APP_VERSION=1.9.21-H3F20-CAP-NEUTRAL-ACTIVITY \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1921_H3F20_CAP_NEUTRAL_ACTIVITY.bin /tmp/app.tar.gz
RUN set -eux; \
