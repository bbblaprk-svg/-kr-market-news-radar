...
ENV NODE_ENV=production \
    APP_VERSION=1.9.30-H3F27-TOP20-LOGIC-RESTORE \
    ...
    NXT_SESSION_SNAPSHOT_MIN_WRITE_MS=60000 \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1943_SHADOW_PRICE.bin /tmp/app.tar.gz
RUN set -eux; \
    ...
    node scripts/verify-ui-ledgers.js; \
    node scripts/verify-mobile-history.js; \
    node scripts/verify-name-closebet10.js; \
    node scripts/verify-nxt-signal-history.js; \
    node scripts/verify-history-price-view.js; \
    node scripts/verify-truth-persistence.js; \
    node scripts/verify-nxt-history-session-persistence.js; \
    node scripts/verify-signal-history-state-color.js; \
    node scripts/verify-h3f27-top20-restore.js; \
    node scripts/verify-h3f26-handoff.js; \
    node scripts/verify-protected-scope-1940.js; \
    node scripts/verify-shadow-price.js; \
    node scripts/verify-shadow-cache.js; \
