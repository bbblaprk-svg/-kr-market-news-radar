FROM node:22-alpine
WORKDIR /app
LABEL gmir.version="4.1.0" gmir.build_id="GMIR-410-TODAY-FIRST-FINAL-20260818"
ENV NODE_ENV=production \
    APP_VERSION=4.1.0 \
    APP_BUILD_ID=GMIR-410-TODAY-FIRST-FINAL-20260818 \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_410_TODAY_FIRST_FINAL.bin /tmp/app.tar.gz
RUN set -eux; \
    tar -xzf /tmp/app.tar.gz -C /app; rm -f /tmp/app.tar.gz; \
    test -f /app/server.js; \
    test -f /app/lib/preSwingEngine.js; \
    test -f /app/lib/marketStateHub.js; \
    grep -Fq "GMIR410_TODAY_FIRST" /app/lib/preSwingEngine.js; \
    grep -Fq "TODAY_FIRST_12_STRUCT12_ROT6" /app/lib/preSwingEngine.js; \
    grep -Fq "todayAccelerationPct:15" /app/lib/preSwingEngine.js; \
    grep -Fq "gmir-shell-v410-today-first" /app/public/sw.js; \
    grep -Fq "./app.js?v=4100t" /app/public/index.html; \
    grep -Fq "v4.1.0" /app/public/index.html; \
    npm run check; \
    rm -rf /tmp/kr-news-radar/* /app/data /app/node_modules; mkdir -p /app/data /tmp/kr-news-radar; \
