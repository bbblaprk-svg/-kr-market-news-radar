...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_201_DATA_GAP_GUARD.bin /tmp/app.tar.gz
RUN set -eux; \
    echo "Using release archive: GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_201_DATA_GAP_GUARD.bin"; \
