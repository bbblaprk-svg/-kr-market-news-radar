...
ENV NODE_ENV=production \
    APP_VERSION=1.9.25-H3F24-UI-LEDGER6-NXT-H3F27-SAFETY-SIGNAL-HISTORY100 \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1933_H3F24_UI_LEDGER6_NXT_SIGNAL_HISTORY100.bin /tmp/app.tar.gz
RUN set -eux; \
