...
ENV NODE_ENV=production \
    APP_VERSION=1.9.25-H3F24-ROOT-CAUSE-FIX-UI-LEDGER4-MOBILE-SCROLL-FIX \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1929_H3F24_UI_LEDGER4_MOBILE_SCROLL_FIX.bin /tmp/app.tar.gz
RUN set -eux; \
