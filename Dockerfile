...
ENV NODE_ENV=production \
    ...
    NAVER_PUBLIC_INTERVAL_MS=360000 \
    WEEKEND_PAUSE=true \
    ACCESS_REFRESH_ENABLED=true \
    ACCESS_REFRESH_MIN_MS=300000 \
    ACCESS_REFRESH_MAX_SOURCES=20 \
    WEEKEND_VIEW_HOURS=48 \
    LOW_DUTY_WINDOWS=true \
    OFFICIAL_TICK_FAST_MS=45000 \
    OFFICIAL_TICK_MARKET_MS=90000 \
    OFFICIAL_TICK_QUIET_MS=240000 \
...
COPY kr_market_news_radar_SEMICON_CHAIN_126.bin /tmp/app.tar.gz
