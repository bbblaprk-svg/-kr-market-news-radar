...
ENV NODE_ENV=production \
    APP_VERSION=1.9.25-H3F24-UI-LEDGER5-NXT-H3F27-SAFETY-RESTORE-TOP10 \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1932_H3F24_UI_LEDGER5_NXT_H3F27_SAFETY_RESTORE_TOP10.bin /tmp/app.tar.gz
RUN set -eux; \
