...
ENV NODE_ENV=production \
    APP_VERSION=1.9.25-H3F24-ROOT-CAUSE-FIX-UI-LEDGER5-NXT-FEED-RESTORE \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1930_H3F24_UI_LEDGER5_NXT_FEED_RESTORE.bin /tmp/app.tar.gz
RUN set -eux; \
