...
ENV NODE_ENV=production \
    APP_VERSION=1.9.25-H3F24-ROOT-CAUSE-FIX-UI-LEDGER3-CLOSEBET10-NAMEFIX \
...
COPY GLOBAL_MARKET_IMPACT_RADAR_RENDER_LS_1928_H3F24_UI_LEDGER3_CLOSEBET10.bin /tmp/app.tar.gz
RUN set -eux; \
